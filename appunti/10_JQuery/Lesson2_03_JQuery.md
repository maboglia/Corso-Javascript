...
- [Esempi Jquery](#esempi-jquery)
	...
	- [Bottone torna su](#bottone-torna-su)
	- [Controlla see img sono caricate](#controlla-see-img-sono-caricate)
	- [Ripara immagini mancanti](#ripara-immagini-mancanti)
	- [Toggle class su hover](#toggle-class-su-hover)
	- [Disabilitare input fields](#disabilitare-input-fields)
	- [ferma il caricamento links](#ferma-il-caricamento-links)
	- [Toggle fade/slide](#toggle-fadeslide)
	- [Semplice accordion](#semplice-accordion)
	- [Fai 2 div con la stessa altezza](#fai-2-div-con-la-stessa-altezza)
	- [ul zebra style](#ul-zebra-style)
	- [Invia data asando il metodo GET](#invia-data-asando-il-metodo-get)
	- [Invia data asando il metodo POST](#invia-data-asando-il-metodo-post)
	- [Recevi testo da una webpage](#recevi-testo-da-una-webpage)
	- [Prendi tutti i valori da un form e inviali ad una pagina web](#prendi-tutti-i-valori-da-un-form-e-inviali-ad-una-pagina-web)
	- [Ricevi JSON data](#ricevi-json-data)
	- [Come mostrare tutti i sotto elementi in jQuery](#come-mostrare-tutti-i-sotto-elementi-in-jquery)
	- [jQuery.unique()](#jqueryunique)
	- [jQuery Dimensions](#jquery-dimensions)
	- [jQuery.each()](#jqueryeach)
	- [Fade out page](#fade-out-page)
	- [Submit form](#submit-form)
	- [jQuery getJSON() Method](#jquery-getjson-method)
	- [Aggiungere icone ai link con jQuery](#aggiungere-icone-ai-link-con-jquery)
	- [Assegnare la classe "active" alla navbar con jQuery](#assegnare-la-classe-%22active%22-alla-navbar-con-jquery)
