...
- [Corso Javascript](#corso-javascript)
  - [](#)
  - [JavaScript è un linguaggio di programmazione](#javascript-%C3%A8-un-linguaggio-di-programmazione)
  - [ruolo di js nel web design](#ruolo-di-js-nel-web-design)
  - [Risorse disponibili online](#risorse-disponibili-online)
  - [Hello, World](#hello-world)
  - [Esecuzione del codice](#esecuzione-del-codice)
  - [Javascript incorporato in una pagina html](#javascript-incorporato-in-una-pagina-html)
  - [Javascript collegato ad una pagina html](#javascript-collegato-ad-una-pagina-html)
  - [Come mostrare a video i dati](#come-mostrare-a-video-i-dati)
- [Strutture del linguaggio](#strutture-del-linguaggio)
  - [JavaScript è __CASE SENSITIVE__](#javascript-%C3%A8-case-sensitive)
  - [Terminare le istruzioni con punto e virgola (;)](#terminare-le-istruzioni-con-punto-e-virgola)
  - [Convenzioni di naming:](#convenzioni-di-naming)
  - [Identificatori](#identificatori)
    - [Per esempio](#per-esempio)
  - [Parole chiave riservate](#parole-chiave-riservate)
  ...
  - [operatori](#operatori)
  - [Commenti](#commenti)
  - [Literals - Letterali (valori letterali per i tipi di dato)](#literals---letterali-valori-letterali-per-i-tipi-di-dato)
- [Strutture del linguaggio](#strutture-del-linguaggio-1)
  - [Costrutti di controllo del flusso](#costrutti-di-controllo-del-flusso)
  - [Costrutti di iterazione (cicli)](#costrutti-di-iterazione-cicli)
- [Tipi di dato](#tipi-di-dato)
  - [Boolean](#boolean)
    - [Per esempio](#per-esempio-1)
  ...
  - [String](#string)
  - [valore nullo e valore undefined](#valore-nullo-e-valore-undefined)
  - [Funzioni](#funzioni)
